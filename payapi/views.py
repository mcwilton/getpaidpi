...
# from .serializers import WebhookSerializer, TransactionsSerializer, BalancesSerializer
...
#
#         account = models.Account.objects.get(credit_card_id=data.get('credit_card_id'))
#
...
#             data={
#                 'error': False,
#                 'message': f'AUTHORIZATION SUCCESSFUL for credit_card_id:{data.get("credit_card_id")} with transaction id:{data.get("transaction_id")}'
#             },
...
#     #     customer = models.Customer.objects.get(credit_card_id=data.get('credit_card_id'))
#
...
#             if serializer.is_valid(raise_exception=True):
#
#                 accounts = models.Account.objects.get(credit_card_id=serializer.data.get('cardholder'))
#
...
#                     credit_card_id=serializer.data.get('cardholder'))
#
#                 transactions_data = {}
#
...
#                                 }
#
#                             transactions_data[i.credit_card_id.credit_card_id][i.type] += float(
#                                 i.billing_amount)
#
#                 accounts_data = {}
#
#                 for i in accounts:
#                     if i.credit_card_id not in accounts_data:
#                         accounts_data[i.credit_card_id] = {
#                             'balance': float(i.total_balance),
#                             'currency': i.currency
#                         }
#
#                     if transactions_data and \
#                             (i.credit_card_id in transactions_data) and \
#                             (serializer.data.get('type') == 'ledger'):
#
#                         accounts_data[i.credit_card_id]['balance'] += transactions_data[i.credit_card_id]['authorisation']
#
#                 response = Response(
#                     data={
#                         'error': False,
