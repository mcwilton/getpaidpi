...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            account = Account.objects.get(credit_card_id=options['cardholder'], currency=options['currency'])
            customer = Customer.objects.get(credit_card_id=options['cardholder'])
