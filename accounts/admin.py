...
class ProfileAdmin(admin.ModelAdmin):
    list_display = ('merchant_id', 'currency', 'total_balance', 'merchant_country')
    list_filter = ('merchant_id', 'currency')
    list_per_page = 10
...
class TransactionAdmin(admin.ModelAdmin):
    list_display = ('transaction_id', 'merchant_name', 'billing_currency', 'billing_amount', 'settled')
    list_filter = ('transaction_id', 'merchant_name', 'billing_currency', 'settled', 'merchant_id')
    list_per_page = 10
...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('order_id', 'merchant_name', 'product_name', 'number_of_products', 'customer_name',
                    'customer_address')
